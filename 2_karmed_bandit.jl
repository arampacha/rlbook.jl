...
# ╔═╡ 8b22a90f-b8e1-4b66-8a9a-3c13bb6190bd
md"""
ε = $(@bind eps1 Slider(0.:0.01:0.2, show_value=true))

Show plot $(@bind show1 CheckBox())
"""
...
md"Show plot $(@bind show2 CheckBox())"
...
md"""
Show non-stationary Q $(@bind show3 CheckBox())

Show unbiased EMA $(@bind show_unbiased CheckBox())
"""
...
md"Show optimistic initial Q $(@bind show_opt CheckBox())"
...
md"Show UBC $(@bind show_ubc CheckBox())"
